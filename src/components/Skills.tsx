      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <div className={`transition-all duration-300 ${expandedSection === 'tech' ? 'block' : 'hidden'}`}>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <div className={`transition-all duration-300 ${expandedSection === 'competencies' ? 'block' : 'hidden'}`}>
              <ul className="space-y-2 text-gray-600">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <div className={`transition-all duration-300 ${expandedSection === 'hobbies' ? 'block' : 'hidden'}`}>
              <ul className="space-y-2 text-gray-600">
                <li>Кино;</li>
